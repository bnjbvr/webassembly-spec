...
assert_return(() => call($$, "as-block-first", [0]), 2);

assert_return(() => call($$, "as-block-first", [1]), 3);

assert_return(() => call($$, "as-block-mid", [0]), 2);

assert_return(() => call($$, "as-block-mid", [1]), 3);

assert_return(() => call($$, "as-block-last", [0]));

assert_return(() => call($$, "as-block-last", [1]));

assert_return(() => call($$, "as-block-last-value", [0]), 11);

assert_return(() => call($$, "as-block-last-value", [1]), 11);

assert_return(() => call($$, "as-loop-first", [0]), 2);

assert_return(() => call($$, "as-loop-first", [1]), 3);

assert_return(() => call($$, "as-loop-mid", [0]), 2);

assert_return(() => call($$, "as-loop-mid", [1]), 4);

assert_return(() => call($$, "as-loop-last", [0]));

assert_return(() => call($$, "as-loop-last", [1]));

assert_return(() => call($$, "as-if-then", [0, 0]));

assert_return(() => call($$, "as-if-then", [4, 0]));

assert_return(() => call($$, "as-if-then", [0, 1]));

assert_return(() => call($$, "as-if-then", [4, 1]));

assert_return(() => call($$, "as-if-else", [0, 0]));

assert_return(() => call($$, "as-if-else", [3, 0]));

assert_return(() => call($$, "as-if-else", [0, 1]));

assert_return(() => call($$, "as-if-else", [3, 1]));

assert_return(() => call($$, "nested-block-value", [0]), 21);

assert_return(() => call($$, "nested-block-value", [1]), 9);

assert_return(() => call($$, "nested-br-value", [0]), 5);

assert_return(() => call($$, "nested-br-value", [1]), 9);

assert_return(() => call($$, "nested-br_if-value", [0]), 5);

assert_return(() => call($$, "nested-br_if-value", [1]), 9);

assert_return(() => call($$, "nested-br_if-value-cond", [0]), 5);

assert_return(() => call($$, "nested-br_if-value-cond", [1]), 9);

assert_return(() => call($$, "nested-br_table-value", [0]), 5);

assert_return(() => call($$, "nested-br_table-value", [1]), 9);

assert_return(() => call($$, "nested-br_table-value-index", [0]), 5);

assert_return(() => call($$, "nested-br_table-value-index", [1]), 9);
