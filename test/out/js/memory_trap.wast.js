...
assert_return(() => call($$, "store", [-4, 42]));

assert_return(() => call($$, "load", [-4]), 42);

assert_trap(() => call($$, "store", [-3, 13]));

assert_trap(() => call($$, "load", [-3]));

assert_trap(() => call($$, "store", [-2, 13]));

assert_trap(() => call($$, "load", [-2]));

assert_trap(() => call($$, "store", [-1, 13]));

assert_trap(() => call($$, "load", [-1]));

assert_trap(() => call($$, "store", [0, 13]));

assert_trap(() => call($$, "load", [0]));

assert_trap(() => call($$, "store", [-2147483648, 13]));

assert_trap(() => call($$, "load", [-2147483648]));

assert_return(() => call($$, "grow_memory", [65537]), -1);
